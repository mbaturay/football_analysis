...
class ViewTransformer():
    def __init__(self, court_width=68, court_length=23.32, pixel_vertices=None, target_vertices=None):
        ...
        self.target_vertices = np.array(target_vertices).astype(np.float32)
